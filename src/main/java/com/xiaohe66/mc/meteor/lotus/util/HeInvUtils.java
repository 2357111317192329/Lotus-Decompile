...
public class HeInvUtils {
    ...
    public static List<ItemStack> findAndMargeShulkerBox() {
        ...
        for (ItemStack kitItemStack : kitItemStackList) {
            ...
            ContainerComponentAccessor containerComponentAccessor = (ContainerComponentAccessor)(Object)components.get(DataComponentTypes.CONTAINER);
            DefaultedList stacks = containerComponentAccessor.meteor$getStacks();
